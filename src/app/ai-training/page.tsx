...
const curriculum = [
  { session: "01", title: "導入 / 業務整理（中分類まで）", desc: "DXとは何か、推進の6ステップ、As-Is整理の基本。WS：業務大分類・中分類の棚卸。成果物：業務一覧表（中分類まで）。" },
  { session: "02", title: "業務整理（小分類）/ 工数集計", desc: "小分類化の観点とポイント、工数集計の方法（標準時間法）。WS：業務小分類の棚卸・工数集計。成果物：業務一覧表（小分類）＋工数集計表。" },
  { session: "03", title: "業務フロー作成 / 課題抽出", desc: "フロー図の基礎（記号・作成ルール）、課題抽出の3観点（工数・品質・顧客満足）。WS：フロー図作成・課題洗い出し。成果物：業務フロー図＋課題一覧表。" },
  { session: "04", title: "AI活用可能性評価 / 打ち手検討", desc: "AIに向く業務・向かない業務の判断基準、インパクト×AI適合性評価マトリクス。WS：課題スコアリング・打ち手ドラフト。成果物：課題一覧表（AI優先度・打ち手付き）。" },
  { session: "05", title: "AIマネジメント4鉄則", desc: "ChatGPT vs Claude（実行革命）、4鉄則（理想・完了条件・プラン・仮説）、デモ4本。WS：自社業務に4鉄則を適用。成果物：自社業務適用プロンプト記録（4業務分）。" },
  { session: "06", title: "スキル制作（コネクター連携含む）", desc: "コネクターとは（Gmail・Calendar等との連携）、スキルの作り方（対話式・手動・外部取込）。WS：コネクターを設定し自社業務のスキルを制作。成果物：制作スキル（コネクター連携含む）。" },
  { session: "07", title: "AI業務改善ロードマップ策定", desc: "打ち手の優先順位付け（3軸評価）、3か月ロードマップの設計原則。WS：自社3か月計画の策定。成果物：AI業務改善ロードマップ（3か月）。" },
  { session: "08", title: "最終レポート / 実装計画発表", desc: "最終レポート完成（前後半の成果物を統合）、各社発表（5〜10分/社）、講師総評・フィードバック。成果物：最終レポート（業務整理〜AI活用計画）。" },
];
